...
1. Every obligation that applies to us is listed with its effective date, verified against the regulation's text and not against a summary of it.
2. No invented citation anywhere: every pinned source opens and says what the memo says it says.
3. The three decisions management must take are stated, each with options and a recommendation.
4. The affected business units are named and none is missing, checked against the org chart rather than memory.
5. One page plus an annex, readable by a non-lawyer in ten minutes.
6. Reviewed by [name] against these tests before it leaves my desk.

Note what the tests are doing. Tests 1 and 2 are worst-case tests: one misstated obligation or one fabricated citation fails the memo, however excellent the rest. Test 4 hunts an absence, which no amount of re-reading the draft would surface, because a missing unit has no paragraph. Test 6 names the confirmation. None of the six mentions polish, length or effort, which is what makes them tests of done rather than tests of finished-looking.

## Deadline pressure

When time runs out and the work does not meet the definition, three honest outcomes exist: refuse to release, obtain more time or amend the definition openly, under your name, with the residual risk stated. "Done enough given the deadline" is not a fourth outcome. It is an amendment seeking anonymity. Sign it or do not release it.
